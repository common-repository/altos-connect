...
echo '<h2>Altos Connect / General Options</h2>' . "\n";
/**/
echo '<hr />' . "\n";
/**/
echo '<form method="post">' . "\n";
echo '<input type="hidden" name="altos_connect_options_save" value="1" />' . "\n";
/**/
...
/**/
echo '<td>' . "\n";
echo '<input type="text" name="altos_connect_username" value="' . format_to_edit ($options["username"]) . '" />' . "\n";
echo '</td>' . "\n";
/**/
echo '</tr>' . "\n";
echo '<tr>' . "\n";
...
/**/
echo '<td>' . "\n";
echo '<input type="password" name="altos_connect_password" value="' . format_to_edit ($options["password"]) . '" />' . "\n";
echo '</td>' . "\n";
/**/
echo '</tr>' . "\n";
echo '</tbody>' . "\n";
